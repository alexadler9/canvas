...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private const val TOOLS_VIEW = 0
        private const val PALETTE_VIEW = 1
        private const val SIZES_VIEW = 2
    }
    ...
    private val layoutSizes: ToolsLayout by lazy { findViewById(R.id.layoutSizes) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolsList = listOf(layoutTools, layoutPalette, layoutSizes)
        ...
        layoutSizes.setOnClickListener {
    ...
    private fun render(viewState: ViewState) {
        ...
        with(toolsList[SIZES_VIEW]) {
            render(viewState.sizesList)
            isVisible = viewState.isSizesVisible
        }
