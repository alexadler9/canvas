...
class CanvasViewModelTest {
    ...
    fun `test initial parameters`() {
        assertFalse(subject.viewState.value.toolsPanelVisible)
        subject.viewState.value.toolsVisibility.forEach {
            assertFalse(it)
        }
    ...
    fun `tools opened`() {
        ...
        assertTrue(subject.viewState.value.toolsPanelVisible)
        subject.viewState.value.toolsVisibility.forEach {
            assertFalse(it)
        }
    }
    ...
    fun `styles opened`() {
        ...
        assertTrue(subject.viewState.value.toolsPanelVisible)
        subject.viewState.value.toolsVisibility.forEachIndexed { index, value ->
            assertThat(value, equalTo(index == Tool.STYLE.ordinal))
        }
    }
    ...
    fun `palette opened`() {
        ...
        assertTrue(subject.viewState.value.toolsPanelVisible)
        subject.viewState.value.toolsVisibility.forEachIndexed { index, value ->
            assertThat(value, equalTo(index == Tool.PALETTE.ordinal))
        }
    }
    ...
    fun `sizes opened`() {
        ...
        assertTrue(subject.viewState.value.toolsPanelVisible)
        subject.viewState.value.toolsVisibility.forEachIndexed { index, value ->
            assertThat(value, equalTo(index == Tool.SIZE.ordinal))
        }
    }
